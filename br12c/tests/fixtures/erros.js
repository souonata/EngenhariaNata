...
export const erros = [
  {
    ...
    modo: "rpn",
    linhas: [{ keys: ["5", "ENTER", "0", "÷"], display: "Error" }],
  },
  {
    nome: "Error: 1/x de zero",
    modo: "rpn",
    linhas: [{ keys: ["0", "1/x"], display: "Error" }],
  },
  {
    nome: "Error: raiz quadrada de negativo",
    modo: "rpn",
    linhas: [{ keys: ["4", "CHS", "g", "√x"], display: "Error" }],
  },
  {
    nome: "Error: LN de zero",
    modo: "rpn",
    linhas: [{ keys: ["0", "g", "LN"], display: "Error" }],
  },
  {
    nome: "Error: fatorial de não-inteiro",
    modo: "rpn",
    linhas: [{ keys: ["1.5", "g", "n!"], display: "Error" }],
  },
  {
    nome: "Erro é limpo ao pressionar uma tecla (digita 7 após ÷0)",
    modo: "rpn",
    linhas: [
      { keys: ["5", "ENTER", "0", "÷"], display: "Error" },
      { keys: ["7"], display: "7" },
    ],
  },
];
