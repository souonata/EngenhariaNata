...
export const secao3 = [
  ...
  },
  {
    ...
    linhas: [
      ...
      { keys: ["STO", "EEX"], display: "0.00" },
      { keys: ["2.152004", "ENTER"], display: "2.15" },
      { keys: ["3.012004"], display: "3.012004" },
      { keys: ["g", "ΔDYS"], display: "15.00" },
      { keys: ["x≷y"], display: "16.00" },
      { keys: ["30", "÷"], display: "0.53" },
      { keys: ["36", "+", "n"], display: "36.53" },
      { keys: ["5", "g", "12÷"], display: "0.42" },
      { keys: ["4500", "PV"], display: "4,500.00" },
      { keys: ["PMT"], display: "-135.17" },
    ],
  },
  {
    ...
    linhas: [
      { keys: ["f", "FIN"], display: "0.00" },
      { keys: ["7.192004", "ENTER"], display: "7.19" },
      { keys: ["8.012004"], display: "8.012004" },
      { keys: ["g", "ΔDYS"], display: "13.00" },
      { keys: ["30", "÷"], display: "0.43" },
      { keys: ["42", "+", "n"], display: "42.43" },
      { keys: ["3950", "PV"], display: "3,950.00" },
      { keys: ["120", "CHS", "PMT"], display: "-120.00" },
      { keys: ["i"], display: "1.16" },
      { keys: ["12", "×"], display: "13.95" },
    ],
  },
];
