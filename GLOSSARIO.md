...
- **BTU por m³** — **Valor de referência usado:** 600 BTU/m³. Este valor considera remoção de calor sensível (temperatura), calor latente (umidade), renovação de ar e perdas térmicas. Baseado em normas técnicas ASHRAE e práticas da indústria.
